import type { AddressTransactionsResponse, AddressTXFullResponse, AssetResponse, AssetsResponse, BalanceResponse, BlockResponse, BlocksResponse, ContractResponse, ContractsResponse, ContractStatsResponse, HeightResponse, InvocationStatsResponse, LogResponse, TokenProvenanceResponse, TransactionResponse, TransactionsResponse, TransferHistoryResponse, VoterResponse, GetFullTransactionsByAddressParams, ExportFullTransactionsByAddressParams } from '../../interfaces/api/neo';
...
export declare class NeoRESTApi {
    ...
    contractStats(contractHash: string, network?: string): Promise<ContractStatsResponse>;
