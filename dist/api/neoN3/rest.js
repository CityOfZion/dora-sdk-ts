...
var NeoRESTApi = (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        method = 'block';
                        return [4, this.get(network, method, blockHeight)];
                    case 1: return [2, _a.sent()];
                }
            });
        });
    ...
    NeoRESTApi.prototype.tokenProvenance = function (contract, tokenId, network) {
        if (network === void 0) { network = 'mainnet'; }
        return __awaiter(this, void 0, void 0, function () {
            var method;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        method = 'token_provenance';
                        return [4, this.get(network, method, contract, tokenId)];
                    case 1: return [2, _a.sent()];
                }
            });
        });
    ...
    NeoRESTApi.prototype.getFullTransactionsByAddress = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.axiosApiV2.post('/unified/activity-history', __assign(__assign({ pageLimit: 50 }, params), { protocol: 'neo3' }))];
                    case 1:
                        data = (_a.sent()).data;
                        return [2, data];
                }
    ...
    NeoRESTApi.prototype.exportFullTransactionsByAddress = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.axiosApiV2.post('/unified/activity-history-csv', __assign(__assign({}, params), { protocol: 'neo3' }))];
                    case 1:
                        data = (_a.sent()).data;
                        return [2, data];
                }
...
exports.NeoN3REST = new NeoRESTApi();
